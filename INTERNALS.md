...
**Webhooks / cmdhooks PUT:** slug maps, same file-body / live overlay as Starr. Validate (including HTTP client) then publish. First-ever hook starts the hook worker.
