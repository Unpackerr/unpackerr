...
// Load parses the embedded definitions.yml schema.
func Load() (*Config, error) {
	return Parse(bytes.NewReader(confBuilder))
}

// Parse decodes a definitions YAML document.
...
// Run is the config generator CLI used by go:generate and unpackerr.github.io.
func Run() {
	flags := parseFlags()
